<main>
    <div class="page-inner-narrow">
        ...
        <p class="page-main-lead">현재 로그인한 이메일 주소를 확인하면<br class="br-mo">비밀번호 재설정 안내를 보내드립니다.</p>
        ...
        <form class="form-box" method="post" action="<?= base_url('mypage/password-reset/request') ?>">
