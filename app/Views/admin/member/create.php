...
<style>
    .member-create-page { color: #172033; font-size: 14px; }
    .member-create-header { display: flex; justify-content: space-between; align-items: flex-start; gap: 16px; padding: 18px 8px 14px; }
    .member-create-header .screen-id { margin-bottom: 6px; color: #64748b; font-size: 13px; font-weight: 700; }
    .member-create-header h1 { margin: 0; font-size: 22px; font-weight: 800; }
    .create-card { border: 1px solid #cbd5e1; border-radius: 8px; background: #fff; box-shadow: 0 1px 3px rgba(15, 23, 42, 0.06); }
...
<div class="content-wrapper">
    <section class="content-header member-create-header member-create-page">
        <div>
            <div class="screen-id">AMFC003_01</div>
            <h1>개인회원 신규 등록</h1>
        </div>
        <div class="text-muted">Main &gt; 대시보드 &gt; 개인회원 &gt; 신규 등록</div>
    </section>

    <section class="content member-create-page">
        <div class="container-fluid">
            <?php if ($error): ?>
                <div class="alert alert-danger"><?= esc($error) ?></div>
            <?php endif; ?>

            <form action="<?= base_url('admin/members/create') ?>" method="post" class="create-card">
                <div class="create-card-head">회원 기본정보</div>
                <div class="create-card-body">
                    <div class="create-grid">
                        ...
                        <div class="create-field">
                            ...
                            <input id="birth" name="birth" type="text" class="form-control" maxlength="8" value="<?= esc(old('birth')) ?>" placeholder="YYYYMMDD">
                        </div>
                        <div class="create-field">
                        ...
                        <div class="create-field">
                            ...
                            <input id="nickname" name="nickname" type="text" class="form-control" value="<?= esc(old('nickname')) ?>">
                        </div>
                        ...
                        <div class="create-field full">
                            ...
                            <textarea id="admin_memo" name="admin_memo" class="form-control" rows="6"><?= esc(old('admin_memo')) ?></textarea>
                        </div>
                    </div>

                    <div class="create-actions">
                        <a href="<?= base_url('admin/members') ?>" class="btn btn-outline-secondary">취소</a>
